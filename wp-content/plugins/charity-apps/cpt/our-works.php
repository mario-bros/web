...
function charity_our_work_post_type() {

	$labels = array(
		'name'                => _x( 'Our work', 'Post Type General Name', 'charity' ),
		'singular_name'       => _x( 'Our works', 'Post Type singular Name', 'charity' ),
		'menu_name'           => __( 'Our work', 'charity' ),
		'name_admin_bar'      => __( 'Our work', 'charity' ),
	...
	register_post_type( 'charity-our-works', $args );
	flush_rewrite_rules();

}

// Hook into the 'init' action
add_action( 'init', 'charity_our_work_post_type', 0 );
