	...
	public static function register_post_types() {
		...
		wc_register_order_type(
			...
			apply_filters( 'woocommerce_register_post_type_shop_order',
				array(
					'labels'              => array(
							'name'               => __( 'Donations', 'woocommerce' ),
							'singular_name'      => __( 'Donation', 'woocommerce' ),
							'add_new'            => __( 'Add Donation', 'woocommerce' ),
							'add_new_item'       => __( 'Add New Donation', 'woocommerce' ),
							'edit'               => __( 'Edit', 'woocommerce' ),
							'edit_item'          => __( 'Edit Donation', 'woocommerce' ),
							'new_item'           => __( 'New Donation', 'woocommerce' ),
							'view'               => __( 'View Donation', 'woocommerce' ),
							'view_item'          => __( 'View Donation', 'woocommerce' ),
							'search_items'       => __( 'Search Donations', 'woocommerce' ),
							'not_found'          => __( 'No Donations found', 'woocommerce' ),
							'not_found_in_trash' => __( 'No Donations found in trash', 'woocommerce' ),
							'parent'             => __( 'Parent Donations', 'woocommerce' ),
							'menu_name'          => _x( 'Donations', 'Admin menu name', 'woocommerce' )
						),
					'description'         => __( 'This is where Donations are stored.', 'woocommerce' ),
					'public'              => false,
					'show_ui'             => true,
