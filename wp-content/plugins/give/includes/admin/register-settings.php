...
// buckaroo
						array(
							'name' => __( 'Buckaroo Donations', 'give' ),
							'desc' => '<hr>',
							'type' => 'give_title',
						...
						array(
							'name' => __( 'Collect Billing Details', 'give' ),
							'desc' => __( 'This option will enable the billing details section for offline donations. The fieldset will appear above the offline donation instructions. Note: You may customize this option per form as needed.', 'give' ),
							'id'   => 'give_buckaroo_donation_enable_billing_fields',
							'type' => 'checkbox'
						),
						array(
							'name'    => __( 'Buckaroo Donation Instructions', 'give' ),
							'desc'    => __( 'The following content will appear for all forms when the user selects the Buckaroo donation payment option. Note: You may customize the content per form as needed.', 'give' ),
							'id'      => 'global_buckaroo_donation_content',
						...
						array(
							...
							'desc'    => __( 'Enter the instructions you want emailed to the donor after they have submitted the donation form. Most likely this would include important information like mailing address and who to make the check out to.', 'give' ),
							'id'      => 'global_buckaroo_donation_email',
