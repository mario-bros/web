! function() {
    ...
    function e(e) {
        ...
        var c = e.noop || function() {}, r = /MSIE/.test(navigator.userAgent),
...
! function(t, e, i) {
    ! function(t) {
        ...
        function a(t) {
            var e, i, n, a;
            return o(t) ? W : (o(t.metadata) && (t.metadata = {
                type: t.metadata
            }), "content" in t && (e = t.content, o(e) || e.jquery || e.done ? e = t.content = {
                text: i = r(e) ? W : e
            } : i = e.text, "ajax" in e && (n = e.ajax, a = n && n.once !== W, delete e.ajax, e.text = function(t, e) {
                var o = i || s(this).attr(e.options.content.attr) || "Loading...",
                    r = s.ajax(s.extend({}, n, {
                        context: e
                    })).then(n.success, k, n.error).then(function(t) {
                        return t && a && e.set("content.text", t), t
                    }, function(t, i, s) {
                        e.destroyed || 0 === t.status || e.set("content.text", i + ": " + s)
                    });
                return a ? o : (e.set("content.text", o), r)
            }), "title" in e && (s.isPlainObject(e.title) && (e.button = e.title.button, e.title = e.title.text), r(e.title || W) && (e.title = W))), "position" in t && o(t.position) && (t.position = {
                my: t.position,
                at: t.position
        ...
        function l(t, e) {
            ...
            for (i in this.checks)
                for (s in this.checks[i])(n = new RegExp(s, "i").exec(t)) && (e.push(n), ("builtin" === i || this.plugins[i]) && this.checks[i][s].apply(this.plugins[i] || this, e))
        }
        ...
        function u(t) {
            this.tooltip.hasClass(G) || (clearTimeout(this.timers.show), clearTimeout(this.timers.hide), this.timers.show = d.call(this, function() {
                this.toggle(z, t)
            }, this.options.show.delay))
        }

        function p(t) {
            if (!this.tooltip.hasClass(G) && !this.destroyed) {
                ...
                } catch (o) {} else this.timers.hide = d.call(this, function() {
                    this.toggle(W, t)
        ...
        function f(t) {
            !this.tooltip.hasClass(G) && this.options.hide.inactive && (clearTimeout(this.timers.inactive), this.timers.inactive = d.call(this, function() {
                this.hide(t)
        ...
        function v(t, i, o) {
            var r, h, l, c, d, u = s(e.body),
                p = t[0] === e ? u : t,
                f = t.metadata ? t.metadata(o.metadata) : k,
                g = "html5" === o.metadata.type && f ? f[o.metadata.name] : k,
                m = t.data(o.metadata.name || "qtipopts");
            try {
                m = "string" == typeof m ? s.parseJSON(m) : m
            } catch (v) {}
            if (c = s.extend(z, {}, x.defaults, o, "object" == typeof m ? a(m) : k, a(g || f)), h = c.position, c.id = i, "boolean" == typeof c.content.text) {
                if (l = t.attr(c.content.attr), c.content.attr === W || !l) return W;
                c.content.text = l
            }
            if (h.container.length || (h.container = u), h.target === W && (h.target = p), c.show.target === W && (c.show.target = p), c.show.solo === z && (c.show.solo = h.container.closest("body")), c.hide.target === W && (c.hide.target = p), c.position.viewport === z && (c.position.viewport = h.container), h.container = h.container.eq(0), h.at = new T(h.at, z), h.my = new T(h.my), t.data(R))
                if (c.overwrite) t.qtip("destroy", !0);
                else if (c.overwrite === W) return W;
            return t.attr(I, i), c.suppress && (d = t.attr("title")) && t.removeAttr("title").attr(Z, d).attr("title", ""), r = new n(t, c, i, !! l), t.data(R, r), r
        }
        ...
        function b(t, e) {
            var s, n, o = e.charAt(0).toUpperCase() + e.slice(1),
                r = (e + " " + ft.join(o + " ") + o).split(" "),
                a = 0;
            if (pt[e]) return t.css(pt[e]);
            for (; s = r[a++];)
                if ((n = t.css(s)) !== i) return pt[e] = s, n
        }
        ...
        C = n.prototype, C._when = function(t) {
            ...
            var e, i = this,
                ...
                c = n.position,
                d = ("." + this._id + " ", []);
            return s.attr(this.target[0], "aria-describedby", this._id), o.posClass = this._createPosClass((this.position = {
                my: c.my,
                at: c.at
            }).my), this.tooltip = r.tooltip = e = s("<div/>", {
                id: this._id,
                "class": [R, Q, n.style.classes, o.posClass].join(" "),
                width: n.style.width || "",
                ...
                "aria-hidden": z
            }).toggleClass(G, this.disabled).attr(N, this.id).data(R, this).appendTo(c.container).append(r.content = s("<div />", {
                "class": R + "-content",
                id: this._id + "-content",
                "aria-atomic": z
            })), this.rendered = -1, this.positioning = z, h && (this._createTitle(), s.isFunction(h) || d.push(this._updateTitle(h, W))), l && this._createButton(), s.isFunction(a) || d.push(this._updateContent(a, W)), this.rendered = z, this._setWidget(), s.each(B, function(t) {
                var e;
                "render" === this.initialize && (e = this(i)) && (i.plugins[t] = e)
            }), this._unassignEvents(), this._assignEvents(), this._when(d).then(function() {
                i._trigger("render"), i.positioning = W, i.hiddenDuringWait || !n.show.ready && !t || i.toggle(z, o.event, W), i.hiddenDuringWait = W
            ...
            function e() {
                if (!this.destroyed) {
                    ...
                    e.removeData(R).removeAttr(N).removeAttr(I).removeAttr("aria-describedby"), this.options.suppress && i && e.attr("title", i).removeAttr(Z), this._unassignEvents(), this.options = this.elements = this.cache = this.timers = this.plugins = this.mouse = k, delete x.api[this.id]
                }
            }
            ...
            builtin: {
                "^id$": function(t, e, i, n) {
                    var o = i === z ? x.nextid : i,
                        r = R + "-" + o;
                    o !== W && o.length > 0 && !s("#" + r).length ? (this._id = r, this.rendered && (this.tooltip[0].id = this._id, this.elements.content[0].id = this._id + "-content", this.elements.title[0].id = this._id + "-title")) : t[e] = n
                },
        ...
        var et = /^position\.(my|at|adjust|target|container|viewport)|style|content|show\.ready/i,
            it = /^prerender|show\.ready/i;
        C.set = function(t, e) {
            if (this.destroyed) return this;
            ...
            return "string" == typeof t ? (i = t, t = {}, t[i] = e) : t = s.extend({}, t), s.each(t, function(e, i) {
                if (n && it.test(e)) return void delete t[e];
                var a, l = h(r, e.toLowerCase());
                a = l[0][l[1]], l[0][l[1]] = i && i.nodeType ? s(i) : i, o = et.test(e) || o, t[e] = [l[0], l[1], i, a]
            }), a(r), this.positioning = z, s.each(t, s.proxy(l, this)), this.positioning = W, this.rendered && this.tooltip[0].offsetWidth > 0 && o && this.reposition("mouse" === r.position.target ? k : this.cache.event), this
        }, C._update = function(t, e, i) {
            var n = this,
                o = this.cache;
            return this.rendered && t ? (s.isFunction(t) && (t = t.call(this.elements.target, o.event, this) || ""), s.isFunction(t.then) ? (o.waiting = z, t.then(function(t) {
                return o.waiting = W, n._update(t, e)
            }, k, function(t) {
                ...
                n.rendered && n.tooltip[0].offsetWidth > 0 && n.reposition(o.event, !t.length)
            }))) : W
            ...
            if (s.isArray(u) && 2 === u.length) f = {
                ...
                u[0] === e || u[0] === t ? (_ = tt.iOS ? t.innerWidth : u.width(), x = tt.iOS ? t.innerHeight : u.height(), u[0] === t && (T = {
                    top: (g || u).scrollTop(),
                    left: (g || u).scrollLeft()
                })) : B.imagemap && u.is("area") ? o = B.imagemap(this, u, f, B.viewport ? y : W) : B.svg && u && u[0].ownerSVGElement ? o = B.svg(this, u, f, B.viewport ? y : W) : (_ = u.outerWidth(W), x = u.outerHeight(W), T = u.offset()), o && (_ = o.width, x = o.height, r = o.offset, T = o.position), T = this.reposition.offset(u, T, m), (tt.iOS > 3.1 && tt.iOS < 4.1 || tt.iOS >= 4.3 && tt.iOS < 4.33 || !tt.iOS && "fixed" === C) && (T.left -= k.scrollLeft(), T.top -= k.scrollTop()), (!o || o && o.adjustable !== W) && (T.left += f.x === D ? _ : f.x === O ? _ / 2 : 0, T.top += f.y === P ? x : f.y === O ? x / 2 : 0)
            }
            return T.left += v.x + (p.x === D ? -b : p.x === O ? -b / 2 : 0), T.top += v.y + (p.y === P ? -w : p.y === O ? -w / 2 : 0), B.viewport ? (a = T.adjusted = B.viewport(this, T, d, _, x, b, w), r && a.left && (T.left += r.left), r && a.top && (T.top += r.top), a.my && (this.position.my = a.my)) : T.adjusted = {
                left: 0,
                top: 0
            }, l.posClass !== (h = this._createPosClass(this.position.my)) && c.removeClass(l.posClass).addClass(l.posClass = h), this._trigger("move", [T, g.elem || g], i) ? (delete T.adjusted, n === W || !q || isNaN(T.left) || isNaN(T.top) || "mouse" === u || !s.isFunction(d.effect) ? c.css(T) : s.isFunction(d.effect) && (d.effect.call(c, this, s.extend({}, T)), c.queue(function(t) {
                s(this).css({
                    opacity: "",
                    height: ""
                }), tt.ie && this.style.removeAttribute("filter"), t()
            })), this.positioning = W, this) : this
        }, C.reposition.offset = function(t, i, n) {
            function o(t, e) {
                i.left += e * t.scrollLeft(), i.top += e * t.scrollTop()
            }
            if (!n[0]) return i;
            var r, a, h, l, c = s(t[0].ownerDocument),
                d = !! tt.ie && "CSS1Compat" !== e.compatMode,
                u = n[0];
            ...
            return r && (r[0] !== c[0] || d) && o(r, 1), i
        };
        var st = (T = C.reposition.Corner = function(t, e) {
        ...
        st.invert = function(t, e) {
            ...
            var n = this.cache,
                ...
                r = this.tooltip;
            if (i) {
                if (/over|enter/.test(i.type) && n.event && /out|leave/.test(n.event.type) && o.show.target.add(i.target).length === o.show.target.length && r.has(i.relatedTarget).length) return this;
                n.event = s.event.fix(i)
            }
            ...
            var e = s(Y),
                ...
                o = x.zindex + e.length;
            return i.hasClass(J) || this._trigger("focus", [o], t) && (n !== o && (e.each(function() {
                this.style.zIndex > n && (this.style.zIndex = this.style.zIndex - 1)
            }), e.filter("." + J).qtip("blur", t)), i.addClass(J)[0].style.zIndex = o), this
        }, C.blur = function(t) {
            return !this.rendered || this.destroyed ? this : (this.tooltip.removeClass(J), this._trigger("blur", [this.tooltip.css("zIndex")], t), this)
        }, C.disable = function(t) {
            return this.destroyed ? this : ("toggle" === t ? t = !(this.rendered ? this.tooltip.hasClass(G) : this.disabled) : "boolean" != typeof t && (t = z), this.rendered && this.tooltip.toggleClass(G, t).attr("aria-disabled", t), this.disabled = !! t, this)
        }, C.enable = function() {
            ...
            var t = this,
                ...
                o = "string" == typeof n,
                r = o ? n : "Close tooltip";
            e.button && e.button.remove(), n.jquery ? e.button = n : e.button = s("<a />", {
                ...
                return i.hasClass(G) || t.hide(e), W
            })
            ...
            var t = this.options.style.widget,
                ...
                i = e.tooltip,
                s = i.hasClass(G);
            i.removeClass(G), G = t ? "ui-state-disabled" : "qtip-disabled", i.toggleClass(G, s), i.toggleClass("ui-helper-reset " + c(), t).toggleClass(Q, this.options.style.def && !t), e.content && e.content.toggleClass(c("content"), t), e.titlebar && e.titlebar.toggleClass(c("header"), t), e.button && e.button.toggleClass(R + "-icon", !t)
        }, C._storeMouse = function(t) {
            return (this.mouse = s.event.fix(t)).type = "mousemove", this
        }, C._bind = function(t, e, i, n, o) {
            if (t && i && e.length) {
                var r = "." + this._id + (n ? "-" + n : "");
                return s(t).bind((e.split ? e : e.join(r + " ")) + r, s.proxy(i, o || this)), this
            }
        }, C._unbind = function(t, e) {
            return t && s(t).unbind("." + this._id + (e ? "-" + e : "")), this
        }, C._trigger = function(t, e, i) {
            var n = s.Event("tooltip" + t);
            return n.originalEvent = i && s.extend({}, i) || this.cache.event || k, this.triggering = t, this.tooltip.trigger(n, [this].concat(e || [])), this.triggering = W, !n.isDefaultPrevented()
        }, C._bindEvents = function(t, e, i, n, o, r) {
            var a = i.filter(n).add(n.filter(i)),
                h = [];
            a.length && (s.each(e, function(e, i) {
                var n = s.inArray(i, t);
                n > -1 && h.push(t.splice(n, 1)[0])
            }), h.length && (this._bind(a, h, function(t) {
                var e = this.rendered ? this.tooltip[0].offsetWidth > 0 : !1;
                (e ? r : o).call(this, t)
            }), i = i.not(a), n = n.not(a))), this._bind(i, t, o), this._bind(n, e, r)
            ...
            this._bind(this.elements.target, ["remove", "removeqtip"], function(t) {
                this.destroy(!0)
            }, "destroy"), /mouse(over|enter)/i.test(i.show.event) && !/mouse(out|leave)/i.test(i.hide.event) && a.push("mouseleave"), this._bind(n, "mousemove", function(t) {
                this._storeMouse(t), this.cache.onTarget = z
            }), this._bindEvents(r, a, n, o, e, function() {
            ...
            var i = this,
                ...
                y = n.hide.event ? s.trim("" + n.hide.event).split(" ") : [];
            s.each(n.events, function(t, e) {
                i._bind(r, "toggle" === t ? ["tooltipshow", "tooltiphide"] : ["tooltip" + t], e, null, r)
            }), /mouse(out|leave)/i.test(n.hide.event) && "window" === n.hide.leave && this._bind(d, ["mouseout", "blur"], function(t) {
                /select|option/.test(t.target.nodeName) || t.relatedTarget || this.hide(t)
            }), n.hide.fixed ? h = h.add(r.addClass(U)) : /mouse(over|enter)/i.test(n.show.event) && this._bind(h, "mouseleave", function() {
                clearTimeout(this.timers.show)
            }), ("" + n.hide.event).indexOf("unfocus") > -1 && this._bind(l.closest("html"), ["mousedown", "touchstart"], function(t) {
                var e = s(t.target),
                    i = this.rendered && !this.tooltip.hasClass(G) && this.tooltip[0].offsetWidth > 0,
                    n = e.parents(Y).filter(this.tooltip[0]).length > 0;
                e[0] === this.target[0] || e[0] === this.tooltip[0] || n || this.target.has(e[0]).length || !i || this.hide(t)
            }), "number" == typeof n.hide.inactive && (this._bind(a, "qtip-" + this.id + "-inactive", f, "inactive"), this._bind(h.add(r), x.inactiveEvents, f)), this._bindEvents(v, y, a, h, u, p), this._bind(a.add(r), "mousemove", function(t) {
                if ("number" == typeof n.hide.distance) {
                    var e = this.cache.origin || {}, i = this.options.hide.distance,
                        s = Math.abs;
                    (s(t.pageX - e.pageX) >= i || s(t.pageY - e.pageY) >= i) && this.hide(t)
                }
                this._storeMouse(t)
            }), "mouse" === o.target && o.adjust.mouse && (n.hide.event && this._bind(a, ["mouseenter", "mouseleave"], function(t) {
                return this.cache ? void(this.cache.onTarget = "mouseenter" === t.type) : W
            }), this._bind(d, "mousemove", function(t) {
                this.rendered && this.cache.onTarget && !this.tooltip.hasClass(G) && this.tooltip[0].offsetWidth > 0 && this.reposition(t)
            })), (o.adjust.resize || c.length) && this._bind(s.event.special.resize ? c : m, "resize", g), o.adjust.scroll && this._bind(m.add(o.container), "scroll", g)
            ...
            n && n.toArray && (r = r.concat(n.toArray())), o && o.toArray && (r = r.concat(o.toArray())), this._unbind(r)._unbind(r, "destroy")._unbind(r, "inactive")
        }, s(function() {
            m(Y, ["mouseenter", "mouseleave"], function(t) {
                var e = "mouseenter" === t.type,
                    i = s(t.currentTarget),
                    n = s(t.relatedTarget || t.target),
                    o = this.options;
                e ? (this.focus(t), i.hasClass(U) && !i.hasClass(G) && clearTimeout(this.timers.hide)) : "mouse" === o.position.target && o.position.adjust.mouse && o.hide.event && o.show.target && !n.closest(o.show.target[0]).length && this.hide(t), i.toggleClass(V, e)
            }), m("[" + N + "]", X, f)
        }), x = s.fn.qtip = function(t, e, n) {
            var o = ("" + t).toLowerCase(),
                r = k,
            ...
            return !arguments.length && c || "api" === o ? c : "string" == typeof t ? (this.each(function() {
                var t = s.data(this, R);
                if (!t) return z;
                if (l && l.timeStamp && (t.cache.event = l), !e || "option" !== o && "options" !== o) t[o] && t[o].apply(t, h);
                else {
                    if (n === i && !s.isPlainObject(e)) return r = t.get(e), W;
                    t.set(e, n)
                }
            }), r !== k ? r : this) : "object" != typeof t && arguments.length ? void 0 : (c = a(s.extend(z, {}, t)), this.each(function(t) {
                var e, i;
                return i = s.isArray(c.id) ? c.id[t] : c.id, i = !i || i === W || i.length < 1 || x.api[i] ? x.nextid++ : i, e = v(s(this), i, c), e === W ? z : (x.api[i] = e, s.each(B, function() {
                    "initialize" === this.initialize && this(e)
                }), void e._assignInitialEvents(l))
            }))
        }, s.qtip = n, x.api = {}, s.each({
            attr: function(t, e) {
                if (this.length) {
                    var i = this[0],
                        n = "title",
                        o = s.data(i, "qtip");
                    if (t === n && o && "object" == typeof o && o.options.suppress) return arguments.length < 2 ? s.attr(i, Z) : (o && o.options.content.attr === n && o.cache.attr && o.set("content.text", e), this.attr(Z, e))
                }
                return s.fn["attr" + K].apply(this, arguments)
            },
            clone: function(t) {
                var e = (s([]), s.fn["clone" + K].apply(this, arguments));
                return t || e.filter("[" + Z + "]").attr("title", function() {
                    return s.attr(this, Z)
                }).removeAttr(Z), e
            }
        }, function(t, e) {
            if (!e || s.fn[t + K]) return z;
            var i = s.fn[t + K] = s.fn[t];
            s.fn[t] = function() {
                return e.apply(this, arguments) || i.apply(this, arguments)
            }
        }), s.ui || (s["cleanData" + K] = s.cleanData, s.cleanData = function(t) {
            for (var e, i = 0;
                (e = s(t[i])).length; i++)
                if (e.attr(I)) try {
                    e.triggerHandler("removeqtip")
                } catch (n) {}
                s["cleanData" + K].apply(this, arguments)
        }), x.version = "2.2.1", x.nextid = 0, x.inactiveEvents = X, x.zindex = 15e3, x.defaults = {
            prerender: W,
            id: W,
            overwrite: z,
            suppress: z,
        ...
        var nt, ot = "margin",
            ...
            pt = {}, ft = ["Webkit", "O", "Moz", "ms"];
        if (dt) var gt = t.devicePixelRatio || 1,
        mt = function() {
        ...
        s.extend(_.prototype, {
            init: function(t) {
                ...
                i = this.element = t.elements.tip = s("<div />", {
                    "class": R + "-tip"
                }).prependTo(t.tooltip), dt ? (e = s("<canvas />").appendTo(this.element)[0].getContext("2d"), e.lineJoin = "miter", e.miterLimit = 1e5, e.save()) : (e = yt("shape", 'coordorigin="0,0"', "position:absolute;"), this.element.html(e + e), t._bind(s("*", i).add(i), ["click", "mousedown"], function(t) {
                    t.stopPropagation()
            ...
            _parseWidth: function(t, e, i) {
                var s = this.qtip.elements,
                    n = rt + y(e) + "Width";
                return (i ? w(i, n) : w(s.content, n) || w(this._useTitle(t) && s.titlebar || s.content, n) || w(s.tooltip, n)) || 0
            },
            _parseRadius: function(t) {
                var e = this.qtip.elements,
                    i = rt + y(t.y) + y(t.x) + "Radius";
                return tt.ie < 9 ? 0 : w(this._useTitle(t) && e.titlebar || e.content, i) || w(e.tooltip, i) || 0
            },
            _invalidColour: function(t, e, i) {
                var s = t.css(e);
                return !s || i && s === t.css(i) || ut.test(s) ? W : s
            },
            _parseColours: function(t) {
                var e = this.qtip.elements,
                    i = this.element.css("cssText", ""),
                    n = rt + y(t[t.precedance]) + y(at),
                    o = this._useTitle(t) && e.titlebar || e.content,
                    r = this._invalidColour,
                    a = [];
                return a[0] = r(i, ht) || r(o, ht) || r(e.content, ht) || r(e.tooltip, ht) || i.css(ht), a[1] = r(i, n, at) || r(o, n, at) || r(e.content, n, at) || r(e.tooltip, n, at) || e.tooltip.css(n), s("*", i).add(i).css("cssText", ht + ":" + lt + ct + ";" + rt + ":0" + ct + ";"), a
            },
            _calculateSize: function(t) {
                var e, i, s, n = t.precedance === E,
                ...
                return u[2] = Math.sqrt(l(u[0], 2) - l(this.border, 2)), u[3] = Math.sqrt(l(u[1], 2) - l(this.border, 2)), e = d + u[2] + u[3] + (a ? 0 : u[0]), i = e / d, s = [c(i * o), c(i * r)], n ? s : s.reverse()
            },
            ...
            create: function() {
                var t = this.corner = (dt || tt.ie) && this._parseCorner(this.options.corner);
            ...
            update: function(e, i) {
                ...
                var n, o, r, a, h, l, c, d, u = this.qtip.elements,
                    p = this.element,
                    f = p.children(),
                    g = this.options,
                    m = this.size,
                    v = g.mimic,
                    y = Math.round;
                e || (e = this.qtip.cache.corner || this.corner), v === W ? v = e : (v = new T(v), v.precedance = e.precedance, "inherit" === v.x ? v.x = e.x : "inherit" === v.y ? v.y = e.y : v.x === v.y && (v[e.precedance] = e[e.precedance])), o = v.precedance, e.precedance === A ? this._swapDimensions() : this._resetDimensions(), n = this.color = this._parseColours(e), n[1] !== lt ? (d = this.border = this._parseWidth(e, e[e.precedance]), g.border && 1 > d && !ut.test(n[1]) && (n[0] = n[1]), this.border = d = g.border !== z ? g.border : d) : this.border = d = 0, c = this.size = this._calculateSize(e), p.css({
                    width: c[0],
                    height: c[1],
                    lineHeight: c[1] + "px"
                    ...
                    left: l[0] - l[2] * Number(o === A),
                    top: l[1] - l[2] * Number(o === E),
                    width: c[0] + d,
                    height: c[1] + d
                }).each(function(t) {
                    var e = s(this);
                    e[e.prop ? "prop" : "attr"]({
                        ...
                        filled: !! t,
                        stroked: !t
                    }).toggle(!(!d && !t)), !t && e.html(yt("stroke", 'weight="' + 2 * d + 'px" color="' + n[1] + '" miterlimit="1000" joinstyle="miter"'))
            ...
            calculate: function(t, e) {
                ...
                return t = t || this.corner, i = t.precedance, e = e || this._calculateSize(t), n = [t.x, t.y], i === A && n.reverse(), s.each(n, function(s, n) {
                    var a, c, d;
                    n === O ? (a = i === E ? F : L, l[a] = "50%", l[ot + "-" + a] = -Math.round(e[i === E ? 0 : 1] / 2) + h) : (a = o._parseWidth(t, n, r.tooltip),
                        c = o._parseWidth(t, n, r.content), d = o._parseRadius(t), l[n] = Math.max(-o.border, s ? c : h + (d > a ? d : -a)))
            ...
            reposition: function(t, e, s, n) {
                function o(t, e, i, s, n) {
                    t === $ && c.precedance === e && d[s] && c[i] !== O ? c.precedance = c.precedance === A ? E : A : t !== $ && d[s] && (c[e] = c[e] === O ? d[s] > 0 ? s : n : c[e] === s ? n : s)
                }

                function r(t, e, n) {
                    c[t] === O ? m[ot + "-" + e] = g[t] = a[ot + "-" + e] - d[e] : (h = a[n] !== i ? [d[e], -a[e]] : [-d[e], a[e]], (g[t] = Math.max(h[0], h[1])) > h[0] && (s[e] -= d[e], g[e] = W), m[a[n] !== i ? n : e] = g[t])
                }
                if (this.enabled) {
                    var a, h, l = e.cache,
                        c = this.corner.clone(),
                    ...
                    this.corner.fixed !== z && (o(p, A, E, F, D), o(f, E, A, L, P), (c.string() !== l.corner.string() || l.cornerTop !== d.top || l.cornerLeft !== d.left) && this.update(c, W)), a = this.calculate(c), a.right !== i && (a.left = -a.right), a.bottom !== i && (a.top = -a.bottom), a.user = this.offset, (g.left = p === $ && !! d.left) && r(A, F, D), (g.top = f === $ && !! d.top) && r(E, L, P), this.element.css(m).toggle(!(g.x && g.y || c.x === O && g.y || c.y === O && g.x)), s.left -= a.left.charAt ? a.user : p !== $ || g.top || !g.left && !g.top ? a.left + this.border : 0, s.top -= a.top.charAt ? a.user : f !== $ || g.left || !g.left && !g.top ? a.top + this.border : 0, l.cornerLeft = d.left, l.cornerTop = d.top, l.corner = c.clone()
                }
            },
            destroy: function() {
    ...
    var t = {
        ...
        unmasked: function() {
            return this.map(function() {
                ...
                }), n = n.replace(/\D/g, ""), n = n.replace(new RegExp(t + "$"), "." + t), a && (n = "-" + n), parseFloat(n)
            })
        },
        init: function(t) {
            return t = e.extend({
                ...
                function a() {
                    var e = !(y.val().length >= y.attr("maxlength") && y.attr("maxlength") >= 0),
                        t = n(),
                        a = t.start,
                        r = t.end,
                        i = t.start !== t.end && y.val().substring(a, r).match(/\d/) ? !0 : !1,
                        o = "0" === y.val().substring(0, 1);
                    return e || i || o
                }
                ...
                function i(e) {
                    var t = "";
                    return e.indexOf("-") > -1 && (e = e.replace("-", ""), t = "-"), t + w.prefix + e + w.suffix
                }

                function o(e) {
                    var t, n, a, r = e.indexOf("-") > -1 && w.allowNegative ? "-" : "",
                        o = e.replace(/[^0-9]/g, ""),
                        s = o.slice(0, o.length - w.precision);
                    return s = s.replace(/^0*/g, ""), s = s.replace(/\B(?=(\d{3})+(?!\d))/g, w.thousands), "" === s && (s = "0"), t = r + s, w.precision > 0 && (n = o.slice(o.length - w.precision), a = new Array(w.precision + 1 - n.length).join(0), t += w.decimal + a + n), i(t)
                }

                function s(e) {
                    var t, n = y.val().length;
                    y.val(o(y.val())), t = y.val().length, e -= n - t, r(e)
                }

                function l() {
                    var e = y.val();
                    w.precision > 0 && e.indexOf(w.decimal) < 0 && (e += w.decimal + new Array(w.precision + 1).join(0)), y.val(o(e))
                }
                ...
                function v(t) {
                    t = t || window.event;
                    var r, i, o, l, v, d = t.which || t.charCode || t.keyCode;
                    return void 0 === d ? !1 : 48 > d || d > 57 ? 45 === d ? (y.val(c()), !1) : 43 === d ? (y.val(y.val().replace("-", "")), !1) : 13 === d || 9 === d ? !0 : !e.browser.mozilla || 37 !== d && 39 !== d || 0 !== t.charCode ? (u(t), !0) : !0 : a() ? (u(t), r = String.fromCharCode(d), i = n(), o = i.start, l = i.end, v = y.val(), y.val(v.substring(0, o) + r + v.substring(l, v.length)), s(o + 1), !1) : !1
                }

                function d(e) {
                    e = e || window.event;
                    var t, a, r, i, o, l = e.which || e.charCode || e.keyCode;
                    return void 0 === l ? !1 : (t = n(), a = t.start, r = t.end, 8 === l || 46 === l || 63272 === l ? (u(e), i = y.val(), a === r && (8 === l ? "" === w.suffix ? a -= 1 : (o = i.split("").reverse().join("").search(/\d/), a = i.length - o - 1, r = a + 1) : r += 1), y.val(i.substring(0, a) + i.substring(r, i.length)), s(a), !1) : 9 === l ? !0 : !0)
                }
                ...
                function p() {
                    var e = parseFloat("0") / Math.pow(10, w.precision);
                    return e.toFixed(w.precision).replace(new RegExp("\\.", "g"), w.decimal)
                }

                function h(t) {
                    if (e.browser.msie && v(t), "" === y.val() || y.val() === i(p())) w.allowZero ? w.affixesStay ? y.val(i(p())) : y.val(p()) : y.val("");
                    else if (!w.affixesStay) {
                        var n = y.val().replace(w.prefix, "").replace(w.suffix, "");
                        y.val(n)
                    }
                    y.val() !== b && y.change()
                }
                ...
                function m() {
                    var e, t = y.get(0);
                    t.setSelectionRange ? (e = y.val().length, t.setSelectionRange(e, e)) : y.val(y.val())
                }
                var w, b, y = e(this);
                w = e.extend({}, t), w = e.extend(w, y.data()), y.unbind(".maskMoney"), y.bind("keypress.maskMoney", v), y.bind("keydown.maskMoney", d), y.bind("blur.maskMoney", h), y.bind("focus.maskMoney", f), y.bind("click.maskMoney", m), y.bind("cut.maskMoney", g), y.bind("paste.maskMoney", g), y.bind("mask.maskMoney", l)
            })
        }
    };
...
! function(e) {
    var t, n, o, i, s, a, r, l = "Close",
        ...
        T = function(e, n) {
            ...
            return s.className = "mfp-" + t, o && (s.innerHTML = o), i ? n && n.appendChild(s) : (s = e(s), n && s.appendTo(n)), s
        }, k = function(n, o) {
            t.ev.triggerHandler(g + n, o), t.st.callbacks && (n = n.charAt(0).toLowerCase() + n.slice(1), t.st.callbacks[n] && t.st.callbacks[n].apply(t, e.isArray(o) ? o : [o]))
        }, O = function(n) {
    ...
    w.prototype = {
        ...
        open: function(n) {
            ...
            k("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (T(u, function(e, t, n, o) {
                n.close_replaceWith = O(o.type)
            }), a += " mfp-close-btn-in") : t.wrap.append(O())), t.st.alignTop && (a += " mfp-align-top"), t.fixedContentPos ? t.wrap.css({
            ...
            return t.isIE7 && (C += " mfp-ie7"), C && t._addClassToMFP(C), t.updateItemHTML(), k("BuildControls"), e("html").css(m), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || o), t._lastFocusedEl = document.activeElement, setTimeout(function() {
                t.content ? (t._addClassToMFP(v), t._setFocus()) : t.bgOverlay.addClass(v), i.on("focusin" + h, t._onFocusIn)
            }, 16), t.isOpen = !0, t.updateSize(d), k(f), n
        },
        close: function() {
            t.isOpen && (k(c), t.isOpen = !1, t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(C), setTimeout(function() {
                t._close()
        ...
        updateItemHTML: function() {
            ...
            var o = n.type;
            if (k("BeforeChange", [t.currItem ? t.currItem.type : "", o]), t.currItem = n, !t.currTemplate[o]) {
                var i = t.st[o] ? t.st[o].markup : !1;
                k("FirstMarkupParse", i), i ? t.currTemplate[o] = e(i) : t.currTemplate[o] = !0
            }
            s && s !== n.type && t.container.removeClass("mfp-" + s + "-holder");
            var a = t["get" + o.charAt(0).toUpperCase() + o.slice(1)](n, t.currTemplate[o]);
            t.appendContent(a, o), n.preloaded = !0, k(m, n), s = n.type, t.container.prepend(t.contentContainer), k("AfterChange")
        },
        appendContent: function(e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[n] === !0 ? t.content.find(".mfp-close").length || t.content.append(O()) : t.content = e : t.content = "", k(d), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(n) {
            var o, i = t.items[n];
            if (i.tagName ? i = {
            ...
            return i.type = o || t.st.type || "inline", i.index = n, i.parsed = !0, t.items[n] = i, k("ElementParse", i), t.items[n]
        },
        ...
        updateStatus: function(e, o) {
            if (t.preloader) {
                ...
                k("UpdateStatus", i), e = i.status, o = i.text, t.preloader.html(o), t.preloader.find("a").on("click", function(e) {
        ...
        _parseMarkup: function(t, n, o) {
            var i;
            o.data && (n = e.extend(o.data, n)), k(u, [t, n, o]), e.each(n, function(e, n) {
                if (void 0 === n || n === !1) return !0;
                if (i = e.split("_"), i.length > 1) {
                    var o = t.find(h + "-" + i[0]);
                    if (o.length > 0) {
                        var s = i[1];
                        "replaceWith" === s ? o[0] !== n[0] && o.replaceWith(n) : "img" === s ? o.is("img") ? o.attr("src", n) : o.replaceWith('<img src="' + n + '" class="' + o.attr("class") + '" />') : o.attr(i[1], n)
                    }
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var i, s = b ? o.data("magnificPopup") : o[0].magnificPopup,
                    a = parseInt(arguments[1], 10) || 0;
                s.items ? i = s.items[a] : (i = o, s.delegate && (i = i.find(s.delegate)), i = i.eq(a)), t._openClick({
                    mfpEl: i
                }, o, s)
    ...
    var E, B, M, S = "inline",
        A = function() {
            M && (B.after(M.addClass(E)).detach(), M = null)
        };
            ...
            getInline: function(n, o) {
                if (A(), n.src) {
                    ...
                    if (s.length) {
                        ...
                        a && a.tagName && (B || (E = i.hiddenClass, B = I(E), E = "mfp-" + E), M = s.after(B).detach().removeClass(E)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(z, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(z), F = t.st.ajax.cursor, T(l + "." + z, H), T("BeforeChange." + z, H)
            },
            getAjax: function(n) {
                F && o.addClass(F), t.updateStatus("loading");
                var i = e.extend({
                    url: n.src,
                    success: function(o, i, s) {
                        ...
                        k("ParseAjax", a), t.appendContent(e(a.data), z), n.finished = !0, j(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(v)
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
                ...
                if (n.enabled && t.supportsTransition) {
                    var i, s, a = n.duration,
                        r = function(e) {
                            ...
                            return i["-webkit-" + s] = i["-moz-" + s] = i["-o-" + s] = i[s] = o, t.css(i), t
                        }, p = function() {
                    ...
                    T("BuildControls" + o, function() {
                        if (t._allowZoom()) {
                            ...
                            s = r(e), s.css(t._getOffset()), t.wrap.append(s), i = setTimeout(function() {
                        ...
                        t._allowZoom() && (p(), s && s.remove(), e = null)
                    })
                }
            },
            _allowZoom: function() {
            ...
            _getOffset: function(n) {
                ...
                var r = {
                    width: o.width(),
                    height: (b ? o.innerHeight() : o[0].offsetHeight) - a - s
                };
...
function give_load_gateway(e, i) {
    var a = jQuery(e).find("#give-payment-mode-select .give-loading-animation"),
        t = jQuery(e).find("#give-amount").val(),
    ...
    1 != n["blockUI.isBlocked"] && jQuery(e).find("#give_purchase_form_wrap").block({
        ...
        jQuery(e).unblock(), jQuery(e).find("#give_purchase_form_wrap").html(i), jQuery(".give-no-js").hide(), jQuery(e).find("#give-payment-mode-wrap .give-loading-text").fadeOut(), setup_give_tooltips(), setup_form_loading_images()
    })
}
...
jQuery(document).ready(function(e) {
    setup_give_tooltips(), setup_form_loading_images(), e(".give-loading-text").hide(), e("body").on("click", ".give_checkout_register_login", function(i) {
        var a = e(this),
            t = {
                action: a.data("action")
            }, o = e(this).parents("form"),
            n = e(o).find("#give-login-account-wrap .give-loading-text");
        return n.show(), e.post(give_scripts.ajaxurl, t, function(i) {
            e(o).find("#give_checkout_login_register").html("").html(i)
        }).done(function() {
            setup_form_loading_images(), n.hide()
        }), !1
    }), e(document).on("click", "#give_login_fields input[type=submit]", function(i) {
        i.preventDefault();
        var a = e(this).val(),
            t = e(this).parents("form");
        e(this).val(give_global_vars.purchase_loading), t.find("#give_login_fields .give-loading-animation").fadeIn();
        var o = {
            action: "give_process_checkout_login",
            give_ajax: 1,
            give_user_login: t.find("#give_user_login").val(),
            give_user_pass: t.find("#give_user_pass").val()
        };
        e.post(give_global_vars.ajaxurl, o, function(i) {
            "success" == e.trim(i) ? (t.find(".give_errors").remove(), give_load_gateway(t, t.find(".give-gateway-option-selected input").val())) : (t.find("#give_login_fields input[type=submit]").val(a), t.find(".give-loading-animation").fadeOut(), t.find(".give_errors").remove(), t.find("#give-user-login-submit").before(i))
        })
    }), e("select#give-gateway, input.give-gateway").on("change", function(i) {
        i.preventDefault();
        var a = e(this).val();
        return "0" == a ? (console.log("There was a problem loading the selected gateway"), !1) : (give_load_gateway(e(this).parents("form"), a), !1)
    }), e("body").on("click touchend", "#give-purchase-button", function(i) {
        var a = e(this).parents("form.give-form"),
            t = a.find("#give_purchase_submit .give-loading-animation");
        t.fadeIn();
        var o = a.get(0);
        if ("function" == typeof o.checkValidity && o.checkValidity() === !1) return void t.fadeOut();
        i.preventDefault();
        var n = e(this).val();
        e(this).val(give_global_vars.purchase_loading), e.post(give_global_vars.ajaxurl, a.serialize() + "&action=give_process_checkout&give_ajax=true", function(i) {
            "success" == e.trim(i) ? (a.find(".give_errors").remove(), e(o).submit()) : (a.find("#give-purchase-button").val(n), t.fadeOut(), a.find(".give_errors").remove(), a.find("#give_purchase_submit").before(i))
        })
    })
});
var give_scripts, give_global_vars;
jQuery(document).ready(function(e) {
    function a(e) {
        var a = e.parents("form"),
            t = e;
        t.validateCreditCard(function(e) {
            var i = a.find(".card-type");
            null == e.card_type ? (i.removeClass().addClass("off card-type"), t.removeClass("valid"), t.addClass("error")) : (i.removeClass("off"), i.addClass(e.card_type.name), e.length_valid && e.luhn_valid ? (t.addClass("valid"), t.removeClass("error")) : (t.removeClass("valid"), t.addClass("error")))
        })
    }

    function t(a) {
		
        var t = a.parents("form"),
            i = a.val(),
            n = a.data("price-id"),
            o = t.find(".give-currency-symbol").text();
 
        //var l = o + i;
		var a = jQuery('.give-select-level-twee');
       var t = a.parents("form"),
            itwee = a.val(),
            n = a.data("price-id");
            //o = t.find(".give-currency-symbol").text();		
       ...
       if (e(a).parents(".give-donation-levels-wrap").find(".give-default-level").removeClass("give-default-level"), e(a).addClass("give-default-level"), t.find("#give-amount").removeClass("invalid-amount"), "custom" === i) return t.find("#give-amount").val("").focus(), !1;
        n || (n = a.find("option:selected").data("price-id")), t.find(".give-updating-price-loader").stop().fadeIn().fadeOut(), t.find("input[name=give-price-id]").val(n), t.find("input#give-amount").val(i), t.find("span#give-amount").text(i);		
		
        "after" == give_global_vars.currency_pos && (l = i + o), t.find(".give-final-total-amount").data("total", i).text(l)
    }
    ...
    function xt(a) {
       ...
       var t = a.parents("form"),
		...
		var a = jQuery('.give-select-level');
       var t = a.parents("form"),
            itwee = a.val(),
            n = a.data("price-id");
            //o = t.find(".give-currency-symbol").text();		
 ...
 if (e(a).parents(".give-donation-levels-wrap").find(".give-default-level").removeClass("give-default-level"), e(a).addClass("give-default-level"), t.find("#give-amount").removeClass("invalid-amount"), "custom" === i) return t.find("#give-amount").val("").focus(), !1;
    ...
    var i = e("body");
    i.on("change", "#give_cc_address input.card_state, #give_cc_address select", function() {
        var a = e(this),
            t = a.parents("form");
        if ("card_state" != a.attr("id")) {
            ...
            e.ajax({
                ...
                success: function(a) {
                    if ("nostates" == a) {
                        var i = '<input type="text" name="card_state" class="cart-state give-input required" value=""/>';
                        t.find('input[name="card_state"], select[name="card_state"]').replaceWith(i)
                    } else t.find('input[name="card_state"], select[name="card_state"]').replaceWith(a);
                    e("body").trigger("give_checkout_billing_address_updated", [a])
                }
            }).fail(function(e) {
        ...
        return !1
    }), i.on("keyup change", ".give-do-validate .card-number", function() {
        a(e(this))
    }), i.on("submit", "#give_payment_mode", function() {
        var a = e("#give-gateway option:selected").val();
        return 0 == a ? (alert(give_global_vars.no_gateway), !1) : void 0
    }), i.on("click", "#give-payment-mode-select input", function() {
        e("#give-payment-mode-select label.give-gateway-option-selected").removeClass("give-gateway-option-selected"), e("#give-payment-mode-select input:checked").parent().addClass("give-gateway-option-selected")
    }), i.on("focus", ".give-donation-amount .give-text-input", function(a) {
        var t = e(this).parents("form");
        e(this).removeClass("invalid-amount"), e(this).maskMoney({
            decimal: give_global_vars.decimal_separator,
            thousands: give_global_vars.thousands_separator
        }), e(this).data("amount", e(this).val()), e(this).parent(".give-donation-amount").addClass("give-custom-amount-focus-in"), t.find(".give-default-level, .give-radio-input").removeClass("give-default-level"), t.find(".give-btn-level-custom").addClass("give-default-level"), t.find(".give-radio-input").prop("checked", !1), t.find(".give-radio-input.give-radio-level-custom").prop("checked", !0), t.find(".give-select-level").prop("selected", !1), t.find(".give-select-level .give-donation-level-custom").prop("selected", !0)
    }), i.on("blur", ".give-donation-amount .give-text-input", function(a) {
        var t = e(this).data("amount"),
            i = e(this).val(),
            n = give_global_vars.currency_sign + i;
        "after" == give_global_vars.currency_pos && (n = i + give_global_vars.currency_sign), (!i || 0 >= i) && e(this).addClass("invalid-amount"), t !== i && (e(this).parents("form").find(".give-final-total-amount").data("total", i).text(n), e(this).next(".give-updating-price-loader").find(".give-loading-animation").css("background-image", "url(" + give_scripts.ajax_loader + ")"), e(this).next(".give-updating-price-loader").stop().fadeIn().fadeOut()), e(this).parent(".give-donation-amount").removeClass("give-custom-amount-focus-in")
    }), i.on("click touchend", ".give-donation-level-btn", function(a) {
        a.preventDefault(), t(e(this))
    }), i.on("click touchend", ".give-radio-input-level", function(a) {
        t(e(this))
    }), i.on("change", ".give-select-level", function(a) {
        t(e(this))
    }),i.on("change", ".give-select-level-twee", function(a) {
        xt(e(this))
    })
});
var give_scripts;
jQuery(document).ready(function(e) {
    var n = e("body");
    n.on("click", ".give-btn-reveal", function(n) {
        n.preventDefault();
        var i = e(this),
            t = e(this).parents("form");
        return i.hide(), t.find("#give-payment-mode-select, #give_purchase_form_wrap").slideDown(), !1
    }), n.on("click", ".give-btn-modal", function(n) {
        n.preventDefault();
        var i = e(this).parents("div.give-form-wrap"),
            t = i.find("#give-amount"),
            o = t.val();
        return !o || 0 >= o ? (t.focus(), !1) : void e.magnificPopup.open({
            ...
            callbacks: {
                open: function() {
                    e(".mfp-content").outerWidth() >= 500 && e(".mfp-content").addClass("give-responsive-mfp-content")
                },
                close: function() {
                    i.removeClass("mfp-hide")
                }
            }
        })
    })
