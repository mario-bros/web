	...
	public function response_handler() {
        ...
        function payment_fields() {
            ?>
                ...
                <fieldset>
                    <p class="form-row">
                            <label for="buckaroo-paygarant-gender"><?php echo _e('Gender:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarant-firstname"><?php echo _e('Firstname:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarant-lastname"><?php echo _e('Lastname:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarant-bankaccount"><?php echo _e('IBAN:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required validate-email">
                            <label for="buckaroo-paygarant-email"><?php echo _e('E-mail:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarant-birthdate"><?php echo _e('Birthdate:', 'woocommerce')?><span class="required">*</span></label>
        ...
        function init_form_fields() {
            ...
            $this->form_fields['paymentmethodspg'] = array(
                                ...
                                'type' => 'multiselect',
                                'css' => 'height: 650px;',
                                'description' => __( 'Select allowed payment methods for Payment Guarantee. (Ctrl+Click select multiple)', 'woocommerce' ),
                                'options' => array(
                                    'ideal' => 'iDEAL',
