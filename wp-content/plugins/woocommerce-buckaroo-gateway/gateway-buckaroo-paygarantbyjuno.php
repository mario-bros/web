	...
	public function response_handler() {
        ...
        function payment_fields() {
            ?>
                ...
                <fieldset>
                    <p class="form-row">
                            <label for="buckaroo-paygarantbyjuno-gender"><?php echo _e('Gender:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarantbyjuno-firstname"><?php echo _e('Firstname:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarantbyjuno-lastname"><?php echo _e('Lastname:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarantbyjuno-bankaccount"><?php echo _e('IBAN:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required validate-email">
                            <label for="buckaroo-paygarantbyjuno-email"><?php echo _e('E-mail:', 'woocommerce')?><span class="required">*</span></label>
                    ...
                    <p class="form-row form-row-wide validate-required">
                            <label for="buckaroo-paygarantbyjuno-birthdate"><?php echo _e('Birthdate:', 'woocommerce')?><span class="required">*</span></label>
        ...
        function init_form_fields() {
            ...
            $this->form_fields['datedue'] = array(
                                'title' => __( 'Number of days between order and invoice', 'woocommerce' ), 
                                'type' => 'text', 
                                'description' => __( 'Maximum days of delay 30.', 'woocommerce' ), 
                                'default' => '14');
            $this->form_fields['sendmail'] = array(
                                'title' => __( 'Send Email', 'woocommerce' ), 
                                'type' => 'select', 
                                'description' => __( 'Send Buckaroo Payment Plaza e-mail to customer.', 'woocommerce' ), 
            ...
            $this->form_fields['paymentmethodspgby'] = array(
                                ...
                                'type' => 'multiselect',
                                'css' => 'height: 650px;',
                                'description' => __( 'Select allowed payment methods for Payment Guarantee ByJuno. (Ctrl+Click select multiple)', 'woocommerce' ),
                                'options' => array(
                                    'ideal' => 'iDEAL',
