...
?>
<h2><?php _e( 'Donation', 'woocommerce' ); ?></h2>
<table class="shop_table order_details">
	<thead>
		<tr>
			<th class="product-name"><?php _e( 'Donation', 'woocommerce' ); ?></th>
				...
				if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
						...
						<div class="order-img">
							...
							//echo get_the_post_thumbnail( $item['product_id'], array( 90, 90));
							}?>
							</div>
								...
								echo apply_filters( 'woocommerce_order_item_quantity_html', ' Peduli Anak Foundation' . '', $item );
						...
						<td class="product-total" style="text-align:right !important;">
	...
	<?php
		...
		if ( $totals = $order->get_order_item_totals() ) {
			foreach ( $totals as $key => $total ) {
				...
				<tr>
					<th scope="row" style="text-align:left !important;"><?php echo $total['label']; ?></th>
					<td style="text-align:right !important;"><?php echo $value; ?></td>
				</tr>
				<?php
				}
			}
...
<header>
	<h2><?php _e( 'Personal details', 'woocommerce' ); ?></h2>
</header>
<table class="shop_table order_details">
<tfoot>
<?php
	if ( $order->billing_email ) {
		echo '<tr><th scope="row" style="text-align:left;">Email:</th><td style="text-align:right !important;">' . $order->billing_email . '</td></tr>';
	}

	if ( $order->billing_phone ) {
		echo '<tr><th scope="row" style="text-align:left;">Telephone:</th><td style="text-align:right !important;">' . $order->billing_phone . '</td></tr>';
	}
