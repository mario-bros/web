...
class VP_ShortcodeGenerator
{
	...
	{
		$this->main_image     = VP_PUBLIC_URL . '/img/charity_shortcode_icon.png';//vp_shortcode_icon.png
		$this->sprite_image   = VP_PUBLIC_URL . '/img/charity_shortcode_icon.png';//vp_shortcode_icon_sprite.png
		...
		?>
			<style type="text/css">
				...
				#qt_content_<?php echo $sg->name; ?>{
					background: url('<?php echo $sg->sprite_image; ?>') 0px 4px no-repeat !important;
					text-indent: -999px;
