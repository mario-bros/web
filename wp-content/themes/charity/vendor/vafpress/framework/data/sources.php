...
function vp_gallery_image($value)
{

	return ($value == "image") ? true : false;
}
VP_Security::instance()->whitelist_function('vp_gallery_image');


function vp_gallery_video($value)
{

	return ($value == "video") ? true : false;
}
VP_Security::instance()->whitelist_function('vp_gallery_video');
